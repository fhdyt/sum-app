                    ...
                    <tbody>
                        {
                            data.map((item, index) => (
                                <tr key={item.id}>
                                    <th>{index + 1}</th>
                                    <td><Link to={`form/${item.id}`}><b>{item.perusahaan}</b></Link>
                                        <br />
                                        ...
                                        {showUpload === item.id && (
                                            <div className="flex flex-col gap-1 mt-2">
                                                ...
                                                {item.status === 'Menunggu Pembayaran' && <input type='file' name="bgImg" className="rounded-full input-xs file-input" onChange={(e) => handleUpload(e, item.id, "work")} />}
                                            </div>
                                        )}                                    </td>
                                    <td>{item.order}</td>
                                    <td>{item.bahan}</td>
